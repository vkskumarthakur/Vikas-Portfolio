...
const TechnologyCard = (props) => {
  ...
  return (
    ...
    <div className='min-h-[200px] overflow-hidden'>
        <img src={props.imgsrc} className='min-h-[inherit] h-[200px] w-full transition-all hover:scale-105 '/>
    </div>
    ...
    <div className='w-full'>
        <div className="h-1" style={{width:props.techStatus, backgroundColor:props.techColor}}></div>
    </div>
    </div>
  )
}
