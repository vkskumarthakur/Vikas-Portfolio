...
const MainContainer = () => {
  return (
    ...
    <TopCover/>
    <div className='mt-5'>
    <h2 className='mb-4 text-xl font-bold' id="cardProject">Projects</h2>
    <div className='flex justify-between items-stretch flex-wrap gap-y-5'>
    ...
    <div className='mt-5'>
    <h2 className='mb-4 text-xl font-bold' id="technologyCard">Technologies</h2>
    ...
    <div className='mt-5'>
    <h2 className='mb-4 text-xl font-bold' id="experience">Experiences</h2>
    <div className='flex justify-start items-stretch flex-wrap gap-y-5 gap-x-5'>
    {
